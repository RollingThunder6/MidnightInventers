...
The clustering based algorithms are well known to fall under the NP-Hard type of problems, and Fuzzy C-Means is a generalization of Hard C-Means or K-Means clustering algorithm.
 \\
...
\begin{flushright}
\includegraphics[width=60pt]{achyuth.png}
\end{flushright}
...
\item Date of Birth : $22^{th}$ June, 1995
\item Gender : Male
